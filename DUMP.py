...
[bold white]                  KOCAK                                                                                          
             """,width=90,padding=(0,8),title=f"Banner",style=f"bold pink"))
#--------------------[ BAGIAN-MASUK ]--------------#
def login123():
	os.system('clear')
	banner()
...
def login_lagi334():
	try:
		cetak(nel('Disarankan Untuk Menggunakan Cookie Yang Masih Fresh Cuy',width=90,style=f"bold white"))
		your_cookies = input(' [+] Masukan Cookie Mu : ')
